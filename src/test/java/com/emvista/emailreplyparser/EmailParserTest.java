...
public class EmailParserTest {
    ...
    public void test() {
        ...
        String encodedTtext = "U2FsdXQsCgpPbiBz4oCZb3JnYW5pc2UgY29tbWVudCA" +
				"/CgpBIHBsdXMKSm9zZXR0ZSBGb3J0aXNoIC0gU3RhZ2nDqHJlIGNoZXogS0FMSVBTQQpqb3NldHRlLmZvcnRpc2hAa2FsaXBzYS5jb20KKzMzIDIgOTIgODkgMDIgNTUKCj4gT24gMjEgTWF5IDIwMTksIGF0IDA2OjM2LCBMdWMgQmFzc29u";
        ...
        encodedTtext = "U2FsdXQsCgpPbiBz4oCZb3JnYW5pc2UgY29tbWVudCA" +
				"/CgpBIHBsdXMKSm9zZXR0ZSBGb3J0aXNoIC0gU3RhZ2nDqHJlIGNoZXogS0FMSVBTQQpqb3NldHRlLmZvcnRpc2hAa2FsaXBzYS5jb20KKzMzIDIgOTIgODkgMDIgNTUKCj4gT24gMjEgTWF5IDIwMTksIGF0IDA2OjM2LCBMdWMgQmFzc29u";
    ...
    public void testQuoteHeaders() {
        ...
        String encodedTtext =
				"";
        ...
        encodedTtext =
				"";
        email = parser.parseEncodedEmail(encodedTtext, "blabla", "", false);
        result = parser.encodeBase64Email(email.getVisibleText());
        assertEquals(expected, result);

        encodedTtext =
				"";
        email = parser.parseEncodedEmail(encodedTtext, "blabla", "", false);
        result = parser.encodeBase64Email(email.getVisibleText());
        assertEquals(expected, result);
        ...
        encodedTtext = "UmUgIQpDZWNpIGVzdCB1biBzZWNvbmQgdGVzdAoKX19fX19fX19fX19fX19fX19fX19fX19fX19fX19fX18KClRvOiA/Pz8" +
				"/CkZyb20gOiBqb3NldHRlLmZvcnRpc2hAaG90bWFpbC5jb20gPGpvc2V0dGUuZm9ydGlzaEBob3RtYWlsLmNvbT4KQ0M6Ck9iamV0IDogUkU6IFRlc3QgZGVzIENDIGV0IENDSQpEYXRlIDogbWFyZGkgNSBub3ZlbWJyZSAyMDE5IDE1OjMw";
        email = parser.parseEncodedEmail(encodedTtext, "blabla", "", false);
        result = parser.encodeBase64Email(email.getVisibleText());
        assertEquals(expected, result);
